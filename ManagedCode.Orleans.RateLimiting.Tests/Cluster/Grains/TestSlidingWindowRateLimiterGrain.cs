...
public class TestSlidingWindowRateLimiterGrain : Grain, ITestSlidingWindowRateLimiterGrain
{
    ...
    [SlidingWindowRateLimiter(KeyType.GrainType, permitLimit: 2, queueLimit: 1,
        segmentsPerWindow: 2)] //GrainType as Key, custom options, some of them are default (check Attribute)
