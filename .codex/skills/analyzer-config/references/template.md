...
This template provides a comprehensive starting point for .NET repositories. Copy and customize sections as needed.
...
dotnet_naming_rule.private_field_should_be_camel_case_with_underscore.severity = suggestion
...
# XML and JSON files
[*.{xml,csproj,props,targets,nuspec,resx}]
indent_style = space
indent_size = 2
...
For small projects or quick starts:
...
## Test Project Overlay

Create `tests/.editorconfig` for relaxed test conventions:
...
# Null parameter validation is less strict in tests
dotnet_diagnostic.CA1062.severity = none

# ConfigureAwait is less important in tests
dotnet_diagnostic.CA2007.severity = none

# Allow magic numbers in test data
dotnet_diagnostic.CA1805.severity = none

# Public types in test assemblies do not need XML docs
...
Create `src/Generated/.editorconfig` for generated code:
...
- [Formatting rules](https://learn.microsoft.com/en-us/dotnet/fundamentals/code-analysis/style-rules/formatting-rules)
